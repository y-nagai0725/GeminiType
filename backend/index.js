 ...
 * @type {Array<{ Pattern: string, TypePattern: string[] }>}
 */
...
app.post('/api/typing/ai-comment', async (req, res) => {
  try {
    ...
    - 正確率が低い（特に95%以下）ユーザーには、「スピードを少し落としてでも正確に打つと、スコアが伸びるよ！」といった、計算式の特性に基づいた助言をしてください。
